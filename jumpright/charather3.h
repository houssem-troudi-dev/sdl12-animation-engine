#ifndef CHARATHER3_H_INCLUDED
#define CHARATHER3_H_INCLUDED
#include <SDL/SDL.h>
#include <SDL/SDL_image.h>
#include <SDL/SDL_mixer.h>
#include <SDL/SDL_ttf.h>

#define THROW_ANTICIP_FRAMES   5
#define THROW_EXEC_FRAMES      3
#define THROW_RECOV_FRAMES     4
#define PROJ_FRAMES            3
#define MAX_HEALTH             3
#define MAX_DEATH_FRAMES       12
#define ANIMAL_FRAMES          10  
typedef struct {
...
{   Animal pet;
    ...
    SDL_Surface *idleleftImages[5];
    SDL_Surface *idlerightImages[5];
    SDL_Surface *runleftImages[8];
    SDL_Surface *runrightImages[8];
    SDL_Surface *hitLeftImages[7];
    SDL_Surface *hitRightImages[7];
