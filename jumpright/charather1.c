...
void init_animal(Animal *animal, charathere1 *c1) {
    ...
    for (int i = 0; i < ANIMAL_FRAMES; i++) {
        sprintf(filename, "/home/king/Documents/main_charather 2/pet/idleleft/idle%d.png", i+1);
        animal->idleLeft[i] = IMG_Load(filename);
        
        sprintf(filename, "/home/king/Documents/main_charather 2/pet/idleright/idle%d.png", i+1);
        animal->idleRight[i] = IMG_Load(filename);
        
        sprintf(filename, "/home/king/Documents/main_charather 2/pet/runleft/run%d.png", i+1);
        animal->moveLeft[i] = IMG_Load(filename);
        
        sprintf(filename, "/home/king/Documents/main_charather 2/pet/runright/run%d.png", i+1);
...
void init_health_system(charathere1 *c1) {
    ...
    for (int i = 0; i < 3; i++) {
        sprintf(filename, "/home/king/Documents/main_charather 2/health_bar/h%d.png", i+1);
    ...
    for (int i = 0; i < MAX_DEATH_FRAMES; i++) {
        sprintf(filename, "/home/king/Documents/main_charather 2/health_bar/d%d.png", i+1);
...
void init_charather(charathere1 *c1) {
    ...
    c1->positionimage.y = 800;
    char filename[256];

    for (int i = 0; i < 6; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/idleleft/idle%d.png", i + 1);
        c1->idleleftImages[c1->count0] = IMG_Load(filename);
        if (c1->idleleftImages[c1->count0] != NULL) {
            sprintf(filename, "/home/king/Documents/main_charather 2/idleright/idle%d.png", i + 1);
    ...
    for (int i = 0; i < 8; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/runleft/run%d.png", i + 1);
        c1->runleftImages[c1->count1] = IMG_Load(filename);
        if (c1->runleftImages[c1->count1] != NULL) {
            sprintf(filename, "/home/king/Documents/main_charather 2/runright/run%d.png", i + 1);
    ...
    for (int i = 0; i < 9; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/hitleft/hit%d.png", i + 1);
        c1->hitLeftImages[c1->count2] = IMG_Load(filename);
        if (c1->hitLeftImages[c1->count2] != NULL) {
            sprintf(filename, "/home/king/Documents/main_charather 2/hitright/hit%d.png", i + 1);
    ...
    for (int i = 0; i < 7; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/jumpleft/jump%d.png", i + 1);
        c1->jumpleftImages[c1->count3] = IMG_Load(filename);
        if (c1->jumpleftImages[c1->count3] != NULL) {
            sprintf(filename, "/home/king/Documents/main_charather 2/jumpright/jump%d.png", i + 1);
    ...
    for (int i = 0; i < THROW_ANTICIP_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileleft/phase1/proj%d.png", i+1);
        c1->throwAnticipLeft[i] = IMG_Load(filename);
    }
    for (int i = 0; i < THROW_EXEC_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileleft/phase2/proj%d.png", i+1);
        c1->throwExecLeft[i] = IMG_Load(filename);
    }
    for (int i = 0; i < THROW_RECOV_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileleft/phase3/proj%d.png", i+1);
        c1->throwRecovLeft[i] = IMG_Load(filename);
    }
    for (int i = 0; i < PROJ_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileleft/projectile/proj%d.png", i+1);
        c1->projFramesLeft[i] = IMG_Load(filename);
    }

    for (int i = 0; i < THROW_ANTICIP_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileright/phase1/proj%d.png", i+1);
        c1->throwAnticipRight[i] = IMG_Load(filename);
    }
    for (int i = 0; i < THROW_EXEC_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileright/phase2/proj%d.png", i+1);
        c1->throwExecRight[i] = IMG_Load(filename);
    }
    for (int i = 0; i < THROW_RECOV_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileright/phase3/proj%d.png", i+1);
        c1->throwRecovRight[i] = IMG_Load(filename);
    }
    for (int i = 0; i < PROJ_FRAMES; ++i) {
        sprintf(filename, "/home/king/Documents/main_charather 2/projectileright/projectile/proj%d.png", i+1);
...
void collisionavecclavier(charathere1 *c1) {
    ...
    if (keys[SDLK_a] && c1->ismovingL) {
        c1->isHittingLeft = 1;
        c1->frameHitLeft = (c1->frameHitLeft + 1) % 9;
        c1->compteurhitleft = (c1->compteurhitleft + 1) % 9;
        ...
        c1->isHittingRight = 1;
        c1->frameHitRight = (c1->frameHitRight + 1) % 9;
        c1->compteurhitright = (c1->compteurhitright + 1) % 9;
